...
- Abandonar grupo, Salir de instancia y Abandonar grupo y salir de instancia están siempre disponibles desde el menú principal de ajustes de EZOTools (LAM) y desde los menús rápidos, incluso durante el combate. Estas acciones rápidas son independientes de Resetear instancia y de las herramientas de líder.
...
- Prueba Abandonar grupo tanto como líder como sin serlo y Abandonar grupo y salir de instancia cuando se cumplan ambas condiciones; ambas deben permanecer en Actividades de grupo. Prueba Salir de instancia cuando ESO permita la salida inmediata y comprueba que aparezca únicamente en el panel principal. Repite con ratón, menú de teclado y menú de mando.
