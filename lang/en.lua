...
EZO_STRINGS_EN = {
    ...
    EZO_OPTION_OVERLAY_NOTE             = "Visibility, interaction style, scale, player text, and position settings for the on-screen overlay.",
    ...
    EZO_OPTION_FRIENDS_ACTIVE_HOUSE = "<<1>> (<<2>>)",
    ...
    EZO_OPTION_FRIENDS_CAPTURE_CRAFTING = "Set current: Crafting",
    EZO_OPTION_FRIENDS_CAPTURE_CRAFTING_TOOLTIP = "While visiting a house in Manual mode, store its exact house and owner as the primary Crafting Hall. This button does not travel.",
    EZO_OPTION_FRIENDS_CAPTURE_SECONDARY = "Set current: Secondary",
    EZO_OPTION_FRIENDS_CAPTURE_SECONDARY_TOOLTIP = "While visiting a house in Manual mode, store its exact house and owner as the secondary destination. This button does not travel.",
    ...
    EZO_OPTION_GROUP_MEMBER_TRAVEL = "Group activity member travel",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_NOTE = "Optional member-side response to validated EZOTools activity state received through EZOCore. It never accepts group invitations, confirms ESO travel prompts, or lets the leader issue remote commands.",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED = "Automatically travel to leader after regrouping",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED_TOOLTIP = "Disabled by default. After you manually accept the group invitation, EZOTools can request one direct JumpToGroupMember travel to the current leader when compatible reset state says the leader is waiting in the target trial, dungeon, or arena and ESO confirms that you are not already in the same instance. ESO may still show a native travel prompt or reject the jump; EZOTools does not confirm prompts for you. Requires EZOCore and LibGroupBroadcast on both clients.",
    ...
    EZO_OPTION_INSTANCE_RESET_ENABLED = "Enable instance reset",
    EZO_OPTION_INSTANCE_RESET_ENABLED_TOOLTIP = "Enables the Instance Reset action and its settings. Disabling it prevents new or retained resets from starting, but keeps Cancel Instance Reset available for an existing session.",
    ...
    EZO_OPTION_INSTANCE_RESET_MOVE_STATUS_WINDOW_TOOLTIP = "Shows the full 11-member placement preview and unlocks the reset status window for dragging with the left mouse button. Disabling it restores the real reset state or hides the window.",
    ...
    EZO_OPTION_MAINTENANCE_NOTE           = "Thresholds that decide when the repair and weapon recharge actions become available.",
    ...
    EZO_MENU_GROUP_ACTIVITY_PLAYER_STATUS = "Group information",
    ...
    EZO_MSG_INSTANCE_RESET_DISABLED = "Instance Reset is disabled in EZOTools settings.",
    ...
    EZO_MSG_FRIEND_HOUSE_CAPTURED_CRAFTING = "Current house saved as the primary Crafting Hall: <<1>>.",
    EZO_MSG_FRIEND_HOUSE_CAPTURED_SECONDARY = "Current house saved as the secondary destination: <<1>>.",
    EZO_MSG_FRIEND_HOUSE_CAPTURE_FAILED = "Stand inside a house whose owner ESO can identify, then try again in Manual mode.",
    ...
    EZO_CMD_DEBUG_GROUP_ACTIVITY = "  /ezo debug groupactivity [staging|returning|complete|off] — preview the member Group Activities panel",
    EZO_CMD_DEBUG_HOUSE         = "  /ezo debug house    — current housing diagnostic",
    EZO_CMD_DEBUG_GROUP_ACTIVITY_USAGE = "Usage: /ezo debug groupactivity [staging|returning|complete|off]",
    ...
    EZO_DEBUG_GROUP_ACTIVITY_PANEL_SHOWN = "Group activity member panel simulation shown.",
    EZO_DEBUG_GROUP_ACTIVITY_PANEL_HIDDEN = "Group activity member panel simulation hidden.",
    ...
    EZO_DEBUG_GROUP_ACTIVITY_MEMBER_TRAVEL_TITLE = "EZOTools member activity travel",
    EZO_DEBUG_STATUS_PANEL_CALLBACK_FAILED = "Status panel action failed: <<1>>",
    EZO_GROUP_ACTIVITY_PEER_PANEL_TITLE = "Group Information",
    EZO_GROUP_ACTIVITY_PEER_PHASE_LOCAL = "WAITING",
    EZO_GROUP_ACTIVITY_PEER_PHASE_REMOTE = "REMOTE",
    EZO_GROUP_ACTIVITY_PEER_STATUS_WAITING = "Waiting for leader activity state",
    EZO_GROUP_ACTIVITY_PEER_STATUS_REMOTE = "Leader activity state received",
    EZO_GROUP_INFORMATION_PHASE = "GROUP",
    EZO_GROUP_INFORMATION_STATUS_READY = "Group formed. No group activity is currently active.",
    EZO_GROUP_INFORMATION_MODE_NORMAL = "Normal",
    EZO_GROUP_INFORMATION_MODE_VETERAN = "Veteran",
    EZO_GROUP_ACTIVITY_PEER_TYPE_TRIAL = "Trial",
    EZO_GROUP_ACTIVITY_PEER_TYPE_DUNGEON = "Dungeon",
    EZO_GROUP_ACTIVITY_PEER_TYPE_ARENA = "Arena",
    EZO_GROUP_ACTIVITY_PEER_DIFFICULTY_UNKNOWN = "Difficulty unknown",
    EZO_GROUP_ACTIVITY_PEER_STAGE_IDLE = "IDLE",
    EZO_GROUP_ACTIVITY_PEER_STAGE_STAGING = "STAGING",
    EZO_GROUP_ACTIVITY_PEER_STAGE_RETURNING = "RETURNING",
    EZO_GROUP_ACTIVITY_PEER_STAGE_WAITING_MEMBERS = "WAITING FOR MEMBERS",
    EZO_GROUP_ACTIVITY_PEER_STAGE_COMPLETE = "COMPLETE",
    EZO_GROUP_ACTIVITY_PEER_STAGE_FAILED = "FAILED",
    EZO_GROUP_ACTIVITY_PEER_RESULT_UNKNOWN = "Leader activity result is unknown",
    EZO_GROUP_ACTIVITY_PEER_RESULT_ACTIVE = "Leader activity is in progress",
    EZO_GROUP_ACTIVITY_PEER_RESULT_COMPLETE = "Leader activity is complete",
    EZO_GROUP_ACTIVITY_PEER_RESULT_CANCELLED = "Leader activity was cancelled",
    EZO_GROUP_ACTIVITY_PEER_RESULT_FAILED = "Leader activity failed",
    EZO_GROUP_ACTIVITY_PEER_RESULT_INTERRUPTED = "Leader activity was interrupted and can be resumed",
    EZO_GROUP_ACTIVITY_PEER_PROGRESS_WAITING = "waiting",
    EZO_GROUP_ACTIVITY_PEER_ROWS_TITLE = "GROUP LOCATION",
    EZO_GROUP_ACTIVITY_PEER_METRIC_GROUP = "Group",
    EZO_GROUP_ACTIVITY_PEER_METRIC_PENDING = "Pending",
    EZO_GROUP_ACTIVITY_PEER_METRIC_EZOCORE = "EZOCore",
    EZO_GROUP_ACTIVITY_PEER_METRIC_LEADER = "Leader",
    EZO_GROUP_ACTIVITY_PEER_ROLE_MEMBER = "member",
    EZO_GROUP_ACTIVITY_PEER_ROLE_LEADER = "leader",
    EZO_GROUP_ACTIVITY_PEER_LOCATION_INSTANCE = "in instance",
    EZO_GROUP_ACTIVITY_PEER_LOCATION_NOT_INSTANCE = "not in instance",
    EZO_GROUP_ACTIVITY_PEER_LOCATION_SAME_LEADER = "same instance as leader",
    EZO_GROUP_ACTIVITY_PEER_LOCATION_DIFFERENT_LEADER = "different instance",
    EZO_GROUP_ACTIVITY_PEER_LOCATION_UNKNOWN = "location unknown",
    EZO_GROUP_ACTIVITY_PEER_NOT_IN_GROUP = "not grouped",
    EZO_GROUP_ACTIVITY_PEER_INVITE_RECEIVED = "invited",
    EZO_GROUP_ACTIVITY_PEER_LAST_KNOWN_LOCATION = "last known: <<1>>",
    EZO_GROUP_ACTIVITY_PEER_DISBAND_GAP = "Group transport is paused during the reset disband. The phase and other members' locations are the last information received; your own location and regroup invitation update locally.",
    EZO_GROUP_ACTIVITY_PEER_LEADER_UNKNOWN = "Group leader",
    EZO_GROUP_ACTIVITY_PEER_WAITING_LEADER = "Waiting for the group leader to announce compatible EZO state.",
    EZO_GROUP_ACTIVITY_PEER_NO_ACTIVE_STATE = "The leader is compatible, but no active group activity state has been received.",
    EZO_GROUP_ACTIVITY_PEER_STATE_EXPIRED = "The last leader activity state expired. Waiting for a new update.",
    EZO_GROUP_ACTIVITY_PEER_LEADER_INCOMPATIBLE = "The current leader does not provide a compatible EZOTools activity state.",
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_ACTIVE = "EZOCore group presence is active. Leader status can be received when the leader sends it.",
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_PENDING = "EZOCore group presence is installed but its LibGroupBroadcast transport is not active.",
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_LIB_MISSING = "LibGroupBroadcast is not installed, so EZOCore group presence cannot exchange data.",
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_SERVICE_MISSING = "EZOCore is installed but its group presence service is not available.",
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_CORE_MISSING = "EZOCore is not installed. EZOTools continues with local-only group tools.",
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_UNKNOWN = "EZOCore group presence state is unknown.",
    EZO_GROUP_ACTIVITY_PEER_SIMULATION_ACTIVE = "Debug simulation: this panel is using local test data, not received group traffic.",
    EZO_GROUP_ACTIVITY_PEER_COMPATIBLE = "compatible",
    EZO_GROUP_ACTIVITY_PEER_INCOMPATIBLE = "incompatible",
    EZO_GROUP_ACTIVITY_PEER_UNKNOWN = "unknown",
    ...
    EZO_INSTANCE_RESET_MEMBER_STATUS_NOT_GROUPED = "not in group",
    ...
    EZO_INSTANCE_RESET_MEMBER_LOCATION_SAME_ZONE = "<<1>> · same instance",
    EZO_INSTANCE_RESET_MEMBER_LOCATION_DIFFERENT_ZONE = "<<1>> · different instance",
    EZO_INSTANCE_RESET_MEMBER_LOCATION_LAST_KNOWN = "last seen: <<1>>",
...
EZO_STRINGS_EN["EZO_SIDE_WIDGET_FOOD_HISTORY_MISSING_TOOLTIP"] = "This saved food or drink is not in your inventory."
