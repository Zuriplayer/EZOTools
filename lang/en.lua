...
EZO_STRINGS_EN = {
    ...
    EZO_OPTION_INSTANCE_RESET_NOTE = "Experimental raid leader helper. It snapshots the current group, disbands it, travels to the configured house, waits, returns to the detected trial when possible, and reinvites captured members.",
    ...
    EZO_OPTION_INSTANCE_RESET_DESTINATION = "Reset staging house",
    EZO_OPTION_INSTANCE_RESET_DESTINATION_TOOLTIP = "House used after disbanding the group before returning to the detected instance.",
    ...
    EZO_OPTION_INSTANCE_RESET_WAIT_SECONDS = "Wait at house (seconds)",
    EZO_OPTION_INSTANCE_RESET_WAIT_SECONDS_TOOLTIP = "Time counted only after the addon confirms you arrived at a house. If arrival is not confirmed, the reset is interrupted and can be resumed.",
    ...
    EZO_MSG_INSTANCE_RESET_DESTINATION_UNAVAILABLE = "The configured reset staging house is not available.",
    EZO_MSG_INSTANCE_RESET_WAITING = "Reset staging reached. Waiting <<1>> seconds before returning.",
    EZO_MSG_INSTANCE_RESET_HOME_NOT_CONFIRMED = "Staging house arrival could not be confirmed. The reset was interrupted.",
