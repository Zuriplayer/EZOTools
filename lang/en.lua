...
EZO_STRINGS_EN["EZO_SIDE_WIDGET_FOOD_CONFIRM_TEXT_WITH_TIME"] = "You are about to consume <<1>>.|n|nTime remaining on the current effect: <<2>>."
EZO_STRINGS_EN["EZO_SIDE_WIDGET_FOOD_CONFIRM_TEXT_WITH_EFFECT"] = "You are about to consume <<1>>.|n|nEffect: <<2>>"
EZO_STRINGS_EN["EZO_SIDE_WIDGET_FOOD_CONFIRM_TEXT_WITH_EFFECT_AND_TIME"] = "You are about to consume <<1>>.|n|nEffect: <<2>>|n|nTime remaining on the current effect: <<3>>."
