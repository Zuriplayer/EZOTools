...
EZO_STRINGS_EN = {
    ...
    EZO_OPTION_GROUP_MEMBER_TRAVEL_NOTE = "Optional member-side response to validated EZOTools activity state received through EZOCore. It never accepts group invitations and does not allow the leader to issue remote commands.",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED = "Automatically travel to leader after regrouping",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED_TOOLTIP = "Disabled by default. After you accept a group invitation, requests one travel to the current leader when a compatible EZOTools reset state says that the leader is waiting in the target trial, dungeon, or arena and ESO confirms that you are not already in the same instance. Requires EZOCore and LibGroupBroadcast on both clients.",
