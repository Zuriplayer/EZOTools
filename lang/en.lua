...
EZO_STRINGS_EN = {
    ...
    EZO_GROUP_ACTIVITY_PEER_ROWS_TITLE = "YOUR STATUS",
    ...
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_PENDING = "EZOCore group presence is installed but the LibGroupBroadcast protocol is still pending official IDs.",
