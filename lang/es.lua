...
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_ALERT_REUSE_TOOLTIP"] = "<<1>>|nClic izquierdo para volver a consumirla."
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_ALERT_REUSE_LEGENDARY_TOOLTIP"] = "<<1>>|nClic izquierdo para volver a consumirla. La comida legendaria pedirá confirmación."
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_RECALL_TOOLTIP"] = "No tienes comida o bebida activa.|nClic izquierdo para volver a consumir <<1>>."
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_RECALL_LEGENDARY_TOOLTIP"] = "No tienes comida o bebida activa.|nClic izquierdo para volver a consumir <<1>>. La comida legendaria pedirá confirmación."
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_ACTIVE_REUSE_TOOLTIP"] = "Comida o bebida activa: <<1>>. Tiempo restante: <<2>>.|nClic izquierdo para volver a consumirla."
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_ACTIVE_REUSE_LEGENDARY_TOOLTIP"] = "Comida o bebida activa: <<1>>. Tiempo restante: <<2>>.|nClic izquierdo para volver a consumirla. La comida legendaria pedirá confirmación."
...
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_CONFIRM_TEXT_WITH_TIME"] = "Vas a consumir <<1>>.|n|nTiempo restante del efecto actual: <<2>>."
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_CONFIRM_TEXT_WITH_EFFECT"] = "Vas a consumir <<1>>.|n|nEfecto: <<2>>"
EZO_STRINGS_ES["EZO_SIDE_WIDGET_FOOD_CONFIRM_TEXT_WITH_EFFECT_AND_TIME"] = "Vas a consumir <<1>>.|n|nEfecto: <<2>>|n|nTiempo restante del efecto actual: <<3>>."
...
EZO_STRINGS_ES["EZO_DOT_PET_ACTIVE_TOOLTIP"] = "<<1>>|nClic izquierdo para ocultarla. Invoca otra mascota para sustituirla en memoria."
EZO_STRINGS_ES["EZO_DOT_PET_INACTIVE_TOOLTIP"] = "<<1>>|nClic izquierdo para invocarla. Invoca otra mascota para sustituirla en memoria."
EZO_STRINGS_ES["EZO_DOT_COMPANION_ACTIVE_TOOLTIP"] = "<<1>>|nClic izquierdo para ocultarlo. Invoca otro compañero para sustituirlo en memoria."
EZO_STRINGS_ES["EZO_DOT_COMPANION_INACTIVE_TOOLTIP"] = "<<1>>|nClic izquierdo para invocarlo. Invoca otro compañero para sustituirlo en memoria."
EZO_STRINGS_ES["EZO_DOT_ASSISTANT_ACTIVE_TOOLTIP"] = "<<1>>|nClic izquierdo para ocultarlo. Invoca otro asistente para sustituirlo en memoria."
EZO_STRINGS_ES["EZO_DOT_ASSISTANT_INACTIVE_TOOLTIP"] = "<<1>>|nClic izquierdo para invocarlo. Invoca otro asistente para sustituirlo en memoria."
