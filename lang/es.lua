...
EZO_STRINGS_ES = {
    ...
    EZO_OPTION_GROUP_MEMBER_TRAVEL_NOTE = "Respuesta local y opcional del miembro ante un estado de actividad validado de EZOTools recibido mediante EZOCore. Nunca acepta invitaciones de grupo ni permite al líder ejecutar órdenes remotas.",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED = "Viajar automáticamente al líder al reagruparse",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED_TOOLTIP = "Desactivado por defecto. Después de aceptar una invitación de grupo, solicita un único viaje al líder actual cuando un estado compatible de reset de EZOTools indica que el líder espera en la trial, mazmorra o arena objetivo y ESO confirma que todavía no estás en la misma instancia. Requiere EZOCore y LibGroupBroadcast en ambos clientes.",
