...
EZO_STRINGS_ES = {
    ...
    EZO_OPTION_FRIENDS_CAPTURE_CRAFTING = "Fijar actual: Artesanía",
    EZO_OPTION_FRIENDS_CAPTURE_CRAFTING_TOOLTIP = "Mientras visitas una casa en modo manual, guarda la casa exacta y su propietario como casa primaria de artesanía. El botón no inicia ningún viaje.",
    EZO_OPTION_FRIENDS_CAPTURE_SECONDARY = "Fijar actual: Secundaria",
    EZO_OPTION_FRIENDS_CAPTURE_SECONDARY_TOOLTIP = "Mientras visitas una casa en modo manual, guarda la casa exacta y su propietario como destino secundario. El botón no inicia ningún viaje.",
    ...
    EZO_OPTION_GROUP_MEMBER_TRAVEL = "Viaje de miembros en actividades de grupo",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_NOTE = "Respuesta local y opcional del miembro ante un estado de actividad validado de EZOTools recibido mediante EZOCore. Nunca acepta invitaciones de grupo, confirma avisos nativos de viaje de ESO ni permite al líder ejecutar órdenes remotas.",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED = "Viajar automáticamente al líder al reagruparse",
    EZO_OPTION_GROUP_MEMBER_TRAVEL_ENABLED_TOOLTIP = "Desactivado por defecto. Después de que aceptes manualmente la invitación de grupo, EZOTools puede solicitar un único viaje directo JumpToGroupMember al líder actual cuando un estado compatible de reset indica que el líder espera en la trial, mazmorra o arena objetivo y ESO confirma que todavía no estás en la misma instancia. ESO puede mostrar igualmente un aviso nativo de viaje o rechazar el salto; EZOTools no confirma esos avisos por ti. Requiere EZOCore y LibGroupBroadcast en ambos clientes.",
    ...
    EZO_OPTION_INSTANCE_RESET_MOVE_STATUS_WINDOW_TOOLTIP = "Muestra la vista completa de colocación con 11 miembros y desbloquea la ventana de estado para arrastrarla con el botón izquierdo. Al desactivarlo se restaura el estado real del reset o se oculta la ventana.",
    ...
    EZO_MENU_GROUP_ACTIVITY_PLAYER_STATUS = "Información del grupo",
    ...
    EZO_MSG_FRIEND_HOUSE_CAPTURED_CRAFTING = "Casa actual guardada como casa primaria de artesanía: <<1>>.",
    EZO_MSG_FRIEND_HOUSE_CAPTURED_SECONDARY = "Casa actual guardada como destino secundario: <<1>>.",
    EZO_MSG_FRIEND_HOUSE_CAPTURE_FAILED = "Entra en una casa cuyo propietario pueda identificar ESO y vuelve a intentarlo en modo manual.",
    ...
    EZO_DEBUG_GROUP_ACTIVITY_MEMBER_TRAVEL_TITLE = "Viaje de miembro en actividad EZOTools",
    EZO_DEBUG_STATUS_PANEL_CALLBACK_FAILED = "Falló una acción del panel de estado: <<1>>",
    EZO_GROUP_ACTIVITY_PEER_PANEL_TITLE = "Información del grupo",
    EZO_GROUP_ACTIVITY_PEER_PHASE_LOCAL = "ESPERANDO",
    ...
    EZO_GROUP_INFORMATION_PHASE = "GRUPO",
    EZO_GROUP_INFORMATION_STATUS_READY = "Grupo formado. No hay ninguna actividad de grupo activa.",
    EZO_GROUP_INFORMATION_MODE_NORMAL = "Normal",
    EZO_GROUP_INFORMATION_MODE_VETERAN = "Veterano",
    EZO_GROUP_ACTIVITY_PEER_TYPE_TRIAL = "Trial",
    EZO_GROUP_ACTIVITY_PEER_TYPE_DUNGEON = "Mazmorra",
    EZO_GROUP_ACTIVITY_PEER_TYPE_ARENA = "Arena",
    EZO_GROUP_ACTIVITY_PEER_DIFFICULTY_UNKNOWN = "Dificultad desconocida",
    EZO_GROUP_ACTIVITY_PEER_STAGE_IDLE = "INACTIVO",
    EZO_GROUP_ACTIVITY_PEER_STAGE_STAGING = "PREPARACIÓN",
    EZO_GROUP_ACTIVITY_PEER_STAGE_RETURNING = "REGRESANDO",
    EZO_GROUP_ACTIVITY_PEER_STAGE_WAITING_MEMBERS = "ESPERANDO MIEMBROS",
    EZO_GROUP_ACTIVITY_PEER_STAGE_COMPLETE = "COMPLETADO",
    EZO_GROUP_ACTIVITY_PEER_STAGE_FAILED = "FALLIDO",
    EZO_GROUP_ACTIVITY_PEER_RESULT_UNKNOWN = "Se desconoce el resultado de la actividad del líder",
    EZO_GROUP_ACTIVITY_PEER_RESULT_ACTIVE = "La actividad del líder está en curso",
    EZO_GROUP_ACTIVITY_PEER_RESULT_COMPLETE = "La actividad del líder ha terminado",
    EZO_GROUP_ACTIVITY_PEER_RESULT_CANCELLED = "La actividad del líder fue cancelada",
    EZO_GROUP_ACTIVITY_PEER_RESULT_FAILED = "La actividad del líder ha fallado",
    EZO_GROUP_ACTIVITY_PEER_RESULT_INTERRUPTED = "La actividad del líder fue interrumpida y se puede reanudar",
    EZO_GROUP_ACTIVITY_PEER_PROGRESS_WAITING = "esperando",
    EZO_GROUP_ACTIVITY_PEER_ROWS_TITLE = "UBICACIÓN DEL GRUPO",
    EZO_GROUP_ACTIVITY_PEER_METRIC_GROUP = "Grupo",
    EZO_GROUP_ACTIVITY_PEER_METRIC_PENDING = "Pendientes",
    ...
    EZO_GROUP_ACTIVITY_PEER_LOCATION_SAME_LEADER = "misma instancia que el líder",
    EZO_GROUP_ACTIVITY_PEER_LOCATION_DIFFERENT_LEADER = "instancia diferente",
    EZO_GROUP_ACTIVITY_PEER_LOCATION_UNKNOWN = "ubicación desconocida",
    EZO_GROUP_ACTIVITY_PEER_NOT_IN_GROUP = "sin grupo",
    EZO_GROUP_ACTIVITY_PEER_INVITE_RECEIVED = "invitado",
    EZO_GROUP_ACTIVITY_PEER_LAST_KNOWN_LOCATION = "última conocida: <<1>>",
    EZO_GROUP_ACTIVITY_PEER_DISBAND_GAP = "El transporte de grupo está pausado durante el disband del reset. La fase y la ubicación de los demás son la última información recibida; tu ubicación y la invitación para reagruparte se actualizan localmente.",
    EZO_GROUP_ACTIVITY_PEER_LEADER_UNKNOWN = "Líder del grupo",
    EZO_GROUP_ACTIVITY_PEER_WAITING_LEADER = "Esperando a que el líder del grupo anuncie un estado EZO compatible.",
    EZO_GROUP_ACTIVITY_PEER_NO_ACTIVE_STATE = "El líder es compatible, pero no se ha recibido un estado de actividad de grupo activo.",
    EZO_GROUP_ACTIVITY_PEER_STATE_EXPIRED = "El último estado de actividad del líder ha caducado. Esperando una actualización.",
    EZO_GROUP_ACTIVITY_PEER_LEADER_INCOMPATIBLE = "El líder actual no proporciona un estado de actividad EZOTools compatible.",
    ...
    EZO_GROUP_ACTIVITY_PEER_TRANSPORT_PENDING = "La presencia de grupo de EZOCore está instalada, pero su transporte LibGroupBroadcast no está activo.",
    ...
    EZO_INSTANCE_RESET_MEMBER_STATUS_NOT_GROUPED = "sin grupo",
    ...
    EZO_INSTANCE_RESET_MEMBER_LOCATION_SAME_ZONE = "<<1>> · misma instancia",
    EZO_INSTANCE_RESET_MEMBER_LOCATION_DIFFERENT_ZONE = "<<1>> · otra instancia",
    EZO_INSTANCE_RESET_MEMBER_LOCATION_LAST_KNOWN = "última vista: <<1>>",
