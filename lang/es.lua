...
EZO_STRINGS_ES = {
    ...
    EZO_OPTION_INSTANCE_RESET_NOTE = "Ayuda experimental para raid leader. Captura el grupo actual, lo disbandea, viaja a la casa configurada, espera, vuelve a la trial detectada cuando sea posible y reinvita a los miembros capturados.",
    ...
    EZO_OPTION_INSTANCE_RESET_DESTINATION = "Casa puente para reset",
    EZO_OPTION_INSTANCE_RESET_DESTINATION_TOOLTIP = "Casa usada tras disbandear el grupo antes de volver a la instancia detectada.",
    ...
    EZO_OPTION_INSTANCE_RESET_WAIT_SECONDS = "Espera en casa (segundos)",
    EZO_OPTION_INSTANCE_RESET_WAIT_SECONDS_TOOLTIP = "Tiempo contado solo después de confirmar que has llegado a una casa. Si no se confirma la llegada, el reset se interrumpe y puede reanudarse.",
    ...
    EZO_OPTION_INSTANCE_RESET_INVITE_MEMBERS = "Invitar miembros capturados",
    EZO_OPTION_INSTANCE_RESET_INVITE_MEMBERS_TOOLTIP = "Activado por defecto. Si está activado al iniciar el reset, EZOTools invita a los jugadores capturados en el snapshot inicial del grupo después del viaje de reset.",
    ...
    EZO_MSG_INSTANCE_RESET_DESTINATION_UNAVAILABLE = "La casa puente configurada para reset no está disponible.",
    EZO_MSG_INSTANCE_RESET_WAITING = "Casa puente alcanzada. Esperando <<1>> segundos antes de volver.",
    EZO_MSG_INSTANCE_RESET_HOME_NOT_CONFIRMED = "No se pudo confirmar la llegada a la casa puente. El reset se ha interrumpido.",
    ...
    EZO_INSTANCE_RESET_STATUS_INVITE_SETTING = "Invitaciones: <<1>>",
    EZO_INSTANCE_RESET_STATUS_INVITE_SETTING_ENABLED = "activadas",
    EZO_INSTANCE_RESET_STATUS_INVITE_SETTING_DISABLED = "|cFFAA00DESACTIVADAS|r",
    ...
    EZO_INSTANCE_RESET_STATUS_METRIC_OFF = "No",
    EZO_INSTANCE_RESET_STATUS_MEMBER_STATE_REQUESTS = "<<1>> · invitaciones enviadas: <<2>>",
    EZO_INSTANCE_RESET_STATUS_INVITES_DISABLED_NOTICE = "Las invitaciones automáticas a miembros están desactivadas en ajustes.",
    ...
    EZO_INSTANCE_RESET_STAGE_INVITES_DISABLED = "invitaciones desactivadas en ajustes",
    ...
    EZO_CONFIRM_INSTANCE_RESET_TEXT_INVITES_DISABLED = "Esto capturará el grupo, la trial y el modo, disbandeará el grupo, viajará a la casa puente configurada, esperará y volverá cuando sea posible. Las invitaciones están desactivadas en ajustes, por lo que no se invitará a los miembros capturados.",
