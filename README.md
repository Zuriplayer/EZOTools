...
- Leave group and instance, available when leaving the group and ESO's immediate instance exit are both valid. These two actions are independent from Instance Reset and leader tools.
